...
vars <- c(4:8)          # Variables de elecciones
comps <- c(1:5)         # Numero de componentes
...
colores[colores == 1] <- "dodgerblue3"
colores[colores == 2] <- "red2"
colores[colores == 3] <- "gold2"
